                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        >
                            ...
                            <div className="grid gap-3 grid-cols-2 mt-2">
                                ...
                                <div className="mt-4">
                                    ...
                                    >
                                        ...
                                        <option selected={data.status === "in_progress"} value="in_progress">
                                            In Progress
                                        </option>
                                        <option selected={data.status === "completed"} value="completed">
                                            Completed
                                        </option>
                                    </SelectInput>
                            ...
                            <div className="mt-5 text-right">
                                ...
                                <button className="bg-gray-100 py-2 px-5 text-gray-800  rounded shadow transition-all hover:bg-gray-300">
                                    Submit
                                </button>
                            </div>
                        </form>
